...
!define PRODUCT_FILE_VERSION "1.7.0.0"
...
Section $(DESC_DATCOOR_NOSERVICE) DATCOOR_NOSERVICE
  ...
  File "..\ibaDatCoordinator\bin\Release\de\ibaDatCoordinator.resources.dll"
  SetOutPath "$INSTDIR\fr"
  File "..\ibaDatCoordinator\bin\Release\fr\ibaDatCoordinator.resources.dll"
