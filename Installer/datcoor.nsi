...
!define PRODUCT_FILE_VERSION "1.6.0.0"
...
OutFile "ibaDatCoordinaterInstall_v${PRODUCT_VERSION}.exe"
...
Section $(DESC_DATCOOR_NOSERVICE) DATCOOR_NOSERVICE
  ...
  File "..\ibaDatCoordinator\bin\Debug\Interop.IBAFILESLib.dll"
  File "..\ibaDatCoordinator\bin\Debug\Interop.IbaAnalyzer.dll"
  File "..\ibaDatCoordinator\bin\Debug\ibaDatCoordinator.exe"
  File "..\ibaDatCoordinator\Resources\default.ico"
  File "..\DatCoordinatorPlugins\bin\Debug\DatCoordinatorPlugins.dll"
  SetOutPath "$INSTDIR\de"
  File "..\ibaDatCoordinator\bin\Debug\de\ibaDatCoordinator.resources.dll"
  SetOutPath "$INSTDIR\fr"
  File "..\ibaDatCoordinator\bin\Debug\fr\ibaDatCoordinator.resources.dll"
...
Section $(DESC_DATCOOR_SERVICE) DATCOOR_SERVICE
  ...
  File "..\DatCoordinatorPlugins\bin\Debug\DatCoordinatorPlugins.dll"
  File "..\ibaDatCoordinatorService\bin\Debug\ibaDatCoordinatorService.exe"
  SetOutPath "$INSTDIR\de"
  File "..\ibaDatCoordinator\bin\Debug\de\ibaDatCoordinator.resources.dll"
  SetOutPath "$INSTDIR\fr"
  File "..\ibaDatCoordinator\bin\Debug\fr\ibaDatCoordinator.resources.dll"
