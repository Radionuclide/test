...
Function CheckRequirements
  ...
  ${VersionCompare} $0 "4.6.0" $2
  ${If} $2 == 2
    ;Framework 4.6.0 not found --> stop installer
...
LangString TEXT_FRAMEWORK_MISSING         ${LANG_SPANISH} "La versión 4.6 del .NET framework no está instalada. Por favor, instale esto antes de ejecutar el instalador del ibaPDA. El .NET framework puede encontrarse en el DVD $\"iba Software & Manuals$\” o se puede descargar mediante la actualización de Windows.”
