...
{
    class CircularBuffer<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        public int Capacity
        {
            ...
            set
            {
                ...
                if (value < size)
                    throw new ArgumentOutOfRangeException("value", "Capacity is less than the current number of items in the buffer");
        ...
        {
            if (count > size)
                throw new ArgumentOutOfRangeException("count", "Count is higher than current size");
