namespace iba.Controls
{
    partial class CommonTaskControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBoxNotify = new iba.Utility.CollapsibleGroupBox();
			this.tableLayoutPanel6 = new System.Windows.Forms.TableLayoutPanel();
			this.m_rbNot1stFailureFile = new System.Windows.Forms.RadioButton();
			...
			this.m_rbNot1stFailureTask = new System.Windows.Forms.RadioButton();
			...
			this.tableLayoutPanel6.Controls.Add(this.m_rbNot1stFailureFile, 2, 0);
			...
			this.tableLayoutPanel6.Controls.Add(this.m_rbNot1stFailureTask, 2, 1);
			this.tableLayoutPanel6.Name = "tableLayoutPanel6";
			// 
			// m_rbNot1stFailureFile
			// 
			resources.ApplyResources(this.m_rbNot1stFailureFile, "m_rbNot1stFailureFile");
			this.m_rbNot1stFailureFile.Name = "m_rbNot1stFailureFile";
			this.m_rbNot1stFailureFile.TabStop = true;
			this.m_rbNot1stFailureFile.UseVisualStyleBackColor = true;
			// 
			// m_rbNotAlways
			// 
			...
			// 
			// m_rbNot1stFailureTask
			// 
			resources.ApplyResources(this.m_rbNot1stFailureTask, "m_rbNot1stFailureTask");
			this.m_rbNot1stFailureTask.Name = "m_rbNot1stFailureTask";
			this.m_rbNot1stFailureTask.TabStop = true;
			this.m_rbNot1stFailureTask.UseVisualStyleBackColor = true;
			// 
			// CommonTaskControl
			// 
        ...
        private System.Windows.Forms.RadioButton m_rbNot1stFailureFile;
		...
		private System.Windows.Forms.RadioButton m_rbNot1stFailureTask;
	}
}
