...
namespace iba.Controls
{
    public partial class MonthlyTriggerSettingsControl : UserControl
    {
        ...
        {
            InitializeComponent();
            m_cbMonths.Init((new string[] { iba.Properties.Resources.SelectAllMonths }).Concat(System.Globalization.DateTimeFormatInfo.CurrentInfo.MonthNames.Take(12)), true);
            m_cbDays.min = 1;
            m_cbDays.max = 31;
