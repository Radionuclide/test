...
!ifndef DATCO_MIN
    !define DATCO_MIN 2000000
    !define DATCO_MIN_STR "2.0.0"
!endif
...
Function PreInstall
  ...
  ${If} $0 != ""
    ...
    Call GetVersionNr
    Pop $R0
    IntCmp $R0 ${DATCO_MIN} okVersion oldVersion okVersion
...
LangString UPGRADE_REQUIRED                  ${LANG_ENGLISH} "ibaDatCoordinator v${DATCO_MIN_STR} or higher is required for the plugin.$\r$\nPlease contact iba-AG for an upgrade."
...
LangString UPGRADE_REQUIRED                  ${LANG_GERMAN} "ibaDatCoordinator v${DATCO_MIN_STR} oder höher ist für das Plugin erforderlich.$\r$\nBitte kontaktieren Sie iba AG für ein Upgrade."
